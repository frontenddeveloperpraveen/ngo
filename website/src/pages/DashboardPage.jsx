...
const DashboardPage = () => {
  ...
  const Copy2Clipboard = () => {
    const copyField = `https://nayepankhfoundation.vercel.app/donation?r=${referal}`;
    navigator.clipboard
      .writeText(copyField)
      .then(() => {
    ...
    if (isLoaded && isSignedIn) {
      ...
      axios
        ...
        .then((res) => {
          ...
          const websiteLink = `https://nayepankhfoundation.vercel.app/donation?r=${response.referralId}`;
